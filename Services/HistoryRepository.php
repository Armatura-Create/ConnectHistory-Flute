...
final class HistoryRepository
{
     ...
     *
     * null означает «все серверы»: берём первую привязку ради имени базы и снимаем
     * фильтр по server_id. Разные базы для разных серверов плагин не предполагает —
     * он различает их колонкой server_id внутри одной базы.
     */
    public static function for(?int $fluteServerId): ?self
    {
        ...
        return new self($first['database'], $first['prefix'], 0);
    }
